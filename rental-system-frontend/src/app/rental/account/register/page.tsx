    ...
    <div className="mx-auto max-w-xl p-4">
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <p className="mt-1 text-sm text-slate-600">
          New accounts default to upfront payment until admin vetting is completed.
        </p>
        ...
        <form className="mt-6 grid gap-4 sm:grid-cols-2" onSubmit={onSubmit}>
          ...
          <label className="grid gap-1 text-sm">
            <span className="text-slate-700">UEN</span>
            <input
              type="text"
              value={uen}
          ...
          <label className="grid gap-1 text-sm sm:col-span-2">
            ...
            <textarea
              ...
              className="min-h-24 rounded-xl border border-slate-200 px-3 py-2 text-slate-900 outline-none focus:border-sky-400"
            />
          </label>
          ...
          <button
            type="submit"
            disabled={submitting}
            className="rounded-xl bg-slate-900 px-4 py-3 text-sm font-semibold text-white hover:bg-slate-800 disabled:bg-slate-300 sm:col-span-2"
          >
